...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		this.componentReset = this.element.is('.date') ? ( this.bootcssVer == 3 ? this.element.find('.input-group-addon .glyphicon-remove, .input-group-addon .glyphicon-remove .fa-times').parent() : this.element.find('.add-on .icon-remove, .add-on .icon-remove .fa-times').parent()) : false;
